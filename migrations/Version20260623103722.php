 ...
 */
final class Version20260623103722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_bien_transaction DROP name, DROP slug');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_bien_transaction ADD name VARCHAR(255) NOT NULL, ADD slug VARCHAR(255) NOT NULL');
    }
}
