...
final class Version20260901140928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE caracteristique (id INT AUTO_INCREMENT NOT NULL, icone VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE category_bien (id INT AUTO_INCREMENT NOT NULL, icone VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE category_bien_transaction (id INT AUTO_INCREMENT NOT NULL, icone VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE devise (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, signe VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE fuseau_horaire (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, utc VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE langue_parler (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(10) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE langue_parler_user (langue_parler_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_8B8F5F4A89697D3E (langue_parler_id), INDEX IDX_8B8F5F4AA76ED395 (user_id), PRIMARY KEY (langue_parler_id, user_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE langues (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, iso VARCHAR(10) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE maintenance_setting (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT DEFAULT 0 NOT NULL, title VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, starts_at DATETIME DEFAULT NULL, ends_at DATETIME DEFAULT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE pays (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, iso VARCHAR(5) NOT NULL, devise_id INT DEFAULT NULL, INDEX IDX_349F3CAEF4445056 (devise_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE property_caracteristique (property_id INT NOT NULL, caracteristique_id INT NOT NULL, INDEX IDX_D6F4BE49549213EC (property_id), INDEX IDX_D6F4BE491704EEB7 (caracteristique_id), PRIMARY KEY (property_id, caracteristique_id)) DEFAULT CHARACTER SET utf8mb4');
