 ...
 */
final class Version20260519130938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pays ADD devise_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_349F3CAEF4445056 ON pays');
        $this->addSql('ALTER TABLE pays DROP devise_id');
    }
}
