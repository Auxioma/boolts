 ...
 */
final class Version20260614130829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE slug slug BIGINT GENERATED ALWAYS AS (1000000000 + id) STORED');
