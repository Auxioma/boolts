...
class AgenceImmobiliereResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, ?string $token = null): Response
    {
        if ($token) {
            ...
            return $this->redirectToRoute('agence_immobilierereset_password');
        }
        ...
        try {
            ...
            return $this->redirectToRoute('agence_immobiliereforgot_password_request');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        if (!$user) {
            return $this->redirectToRoute('agence_immobilierecheck_email');
        }
        ...
        try {
            ...
            // the lines below and change the redirect to 'agence_immobiliereforgot_password_request'.
