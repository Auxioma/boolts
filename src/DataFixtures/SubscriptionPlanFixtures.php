...
final class SubscriptionPlanFixtures extends Fixture
{
    ...
    /** Forfait gratuit par défaut (mensuel), utilisé par les autres fixtures. */
    public const FREE_PLAN_REFERENCE = self::SUBSCRIPTION_PLAN_REFERENCE_PREFIX.'free-monthly';
