...
class CreditNoteLine
{
    ...
    public function getCreditNote(): CreditNote { return $this->creditNote; }
    public function setCreditNote(CreditNote $creditNote): static { $this->creditNote = $creditNote; return $this; }
    ...
    public function getUnitAmountMinor(): int { return $this->unitAmountMinor; }
    public function setUnitAmountMinor(int $unitAmountMinor): static { $this->unitAmountMinor = $unitAmountMinor; return $this; }
