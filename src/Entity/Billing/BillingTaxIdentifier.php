...
class BillingTaxIdentifier
{
    ...
    public function getStripeTaxId(): ?string { return $this->stripeTaxId; }
    public function setStripeTaxId(?string $stripeTaxId): static { $this->stripeTaxId = $stripeTaxId; return $this; }

    public function getVerificationStatus(): string { return $this->verificationStatus; }
    public function setVerificationStatus(string $verificationStatus): static { $this->verificationStatus = $verificationStatus; return $this; }

    public function isIsPrimary(): bool { return $this->isPrimary; }
