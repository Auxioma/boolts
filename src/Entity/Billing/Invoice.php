...
class Invoice
{
    ...
    public function getSubscriptionPeriod(): ?AgencySubscriptionPeriod { return $this->subscriptionPeriod; }
    public function setSubscriptionPeriod(?AgencySubscriptionPeriod $subscriptionPeriod): static { $this->subscriptionPeriod = $subscriptionPeriod; return $this; }
    ...
    public function setType(InvoiceType $type): static { $this->type = $type; return $this; }
    ...
    public function setSubtotalMinor(int $subtotalMinor): static { $this->subtotalMinor = $subtotalMinor; return $this; }

    public function getDiscountTotalMinor(): int { return $this->discountTotalMinor; }
    public function setDiscountTotalMinor(int $discountTotalMinor): static { $this->discountTotalMinor = $discountTotalMinor; return $this; }

    public function getTaxableTotalMinor(): int { return $this->taxableTotalMinor; }
    public function setTaxableTotalMinor(int $taxableTotalMinor): static { $this->taxableTotalMinor = $taxableTotalMinor; return $this; }

    public function getTaxTotalMinor(): int { return $this->taxTotalMinor; }
    public function setTaxTotalMinor(int $taxTotalMinor): static { $this->taxTotalMinor = $taxTotalMinor; return $this; }

    public function getTotalMinor(): int { return $this->totalMinor; }
    public function setTotalMinor(int $totalMinor): static { $this->totalMinor = $totalMinor; return $this; }
    ...
    public function getAmountDueMinor(): int { return $this->amountDueMinor; }
    public function setAmountDueMinor(int $amountDueMinor): static { $this->amountDueMinor = $amountDueMinor; return $this; }
    ...
    public function getSellerSnapshot(): array { return $this->sellerSnapshot; }
    public function setSellerSnapshot(array $sellerSnapshot): static { $this->sellerSnapshot = $sellerSnapshot; return $this; }

    public function getCustomerSnapshot(): array { return $this->customerSnapshot; }
    public function setCustomerSnapshot(array $customerSnapshot): static { $this->customerSnapshot = $customerSnapshot; return $this; }

    public function getTaxSnapshot(): array { return $this->taxSnapshot; }
    public function setTaxSnapshot(array $taxSnapshot): static { $this->taxSnapshot = $taxSnapshot; return $this; }
    ...
    public function getProviderInvoicePdfUrl(): ?string { return $this->providerInvoicePdfUrl; }
    public function setProviderInvoicePdfUrl(?string $providerInvoicePdfUrl): static { $this->providerInvoicePdfUrl = $providerInvoicePdfUrl; return $this; }

    public function getProviderHostedInvoiceUrl(): ?string { return $this->providerHostedInvoiceUrl; }
    public function setProviderHostedInvoiceUrl(?string $providerHostedInvoiceUrl): static { $this->providerHostedInvoiceUrl = $providerHostedInvoiceUrl; return $this; }
